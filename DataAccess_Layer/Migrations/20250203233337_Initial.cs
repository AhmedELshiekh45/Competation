...
namespace DataAccess_Layer.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PartRegistrations",
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    NumberOfParts = table.Column<float>(type: "real", nullable: false),
                    SerialNumber = table.Column<int>(type: "int", nullable: false),
                    ExamDate = table.Column<DateOnly>(type: "date", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PartRegistrations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contestants_Teachers_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ContestantId = table.Column<string>(type: "nvarchar(14)", nullable: false),
                    CompetitionId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PartsNumber = table.Column<float>(type: "real", nullable: false),
                    SerialNumber = table.Column<int>(type: "int", nullable: false),
                    TeacherId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exams_AspNetUsers_EntryId",
                        column: x => x.EntryId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Exams_Contestants_ContestantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exams_ContestantId",
                table: "Exams",
                column: "ContestantId");

            migrationBuilder.CreateIndex(
                name: "IX_Exams_EntryId",
                table: "Exams",
                column: "EntryId");
